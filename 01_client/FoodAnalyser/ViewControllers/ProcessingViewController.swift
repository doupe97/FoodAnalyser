...
class ProcessingViewController: UIViewController {
    ...
    public var detailLevel: String = "medium" // default value, if unset
    public var featureSensitivity: String = "normal" // default value, if unset
    
    private var timer: Timer?
    private var isTimerRunning = false
    private var currentDescriptionNumber: Int = 0
    private var descriptions = [ProgressDescription]()
    
    // function gets called when view did load
    override func viewDidLoad() {
        super.viewDidLoad()
        
        // setup the progress descriptions
